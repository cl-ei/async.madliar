$(function(){
    ...
    function initialization(){
        $('#background').on("load", runCanvas); //.attr("src", window.CDN_URL + "/old/static/img/" + generateRadomInt() + ".jpg");
    }
                    ...
                    '<div class="blog-timeline-box">',
                        '<div class="blog-timeline-wrapper">',
                            '<div class="blog-timeline-spin">',
                                '<img src="' + window.CDN_URL + '/old/static/img/head_' + generateRadomInt(5) + '.png">',
                            '</div>',
