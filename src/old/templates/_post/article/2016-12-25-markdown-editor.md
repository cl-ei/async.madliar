...
　　最后值得一提的是，在文章里插入图片其实很简单。虽然这个版本已经十分快捷了，但在下个版本中，把图片拖拽到输入框内，就会自动将链接插入到光标处，只需一步。<img src="/old/static/blog/img/project/20161225/upload_image.gif" style="width: 100%">
### 安全和隐私
