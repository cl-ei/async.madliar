...
from .path_conf import get_user_storage_root, get_user_meta_root
from src.error import ErrorWithPrompt
from typing import Callable


class UserFSAdapter:
    def __init__(self, email: str, storage: None = None):
    ...
    async def copy_tree(self, src: str, dst: str, skip_resolve: bool = False) -> None:
        """
