...
![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/raspberrypi.jpg)
...
![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/raspdownload.jpg)

　　然后在网络上下载“Win32DiskImager”工具，插入内存卡（无需提前格式化），运行Win32DiskImager.exe。如下所示：

![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/raspimg.jpg)
...
![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/uart.jpg)

　　这个东西十几块钱就可以在淘宝上买到，需要注意的是，有的Usb转串口模块输出的是5V电压，这种转换器和树莓派不兼容，应购买3.3V的。下面把串口转换器和树莓派进行连接。

![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/gpios.png)
...
![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/connect.jpg)

　　检查无误后，将Usb转串口插入到电脑。从网络上下载SecureCRT软件并安装，单击“File”，选择“Quick Connect”,弹出下面的窗口。

![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/crtuart1.jpg)

　　选择正确的串口号之后，设置“波特率 115200 无奇偶校验”，开启串口。随便给树莓派发送几个字符，通信正常的话，会收到树莓派的提示：

![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/uartcon.jpg)

　　这个时候，需要输入用户名和密码来登陆树莓派啦。用户名是“pi”，密码是“raspberry”。进入linux系统之后，输入“ifconfig”，即可看到树莓派的当前地址，这个是内网地址：

![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/netcon2.jpg)

　　可以看到，ip为192.168.1.102 。

　　第二种获取树莓派ip地址的办法十分简单粗暴，直接登陆路由器的设置页“192.168.1.1”（有的是192.168.0.1），在DHCP服务器栏查看客户端列表，可以看到：

![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/dhcplist.jpg)
...
![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/secureCRT1.jpg)

　　填写树莓派的ip地址与端口号，树莓派ssh连接的端口号默认为22 。单击“connect”，在弹出的“New Host Key”对话框中，选择“accept&save”。然后输入用户名和密码，就可以登陆上树莓派了。

![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/secureCRT2.jpg)
...
![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/secureCRT3.jpg)
...
![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/vnc1.jpg)

　　注意其中一行：“New "X" desktop is raspberrypi:1 ”，冒号后面所跟的就是通过vnc来访问树莓派的端口，这里是1。在电脑上启动vnc，输入树莓派的ip地址和前面的端口号。

![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/vnc2.jpg)

　　点击连接，输入刚才输入的密码，即可登录到树莓派桌面。

![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/vnc3.jpg)

　　树莓派相较于桌面电脑性能低，而且是通过网络来投射的远程桌面，所以使用vnc来访问树莓派给人的感受只有一个字：慢！但其中也有很多有意思的东西，比方说系统自带的几个Python写的小游戏：
![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/vnc4.jpg)
![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/vnc5.jpg)
![raspberrypi](/src/original-intention/statics/blog/img/project/20150629/vnc6.jpg)
