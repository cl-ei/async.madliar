$(function(){
    ...
    function initialization(){
        $('#background').on("load", runCanvas).attr("src", "/original-intention/statics/blog/img/fake-ui/" + generateRadomInt() + ".jpg");
    }
                    ...
                    '<div class="blog-timeline-box">',
                        '<div class="blog-timeline-wrapper">',
                            '<div class="blog-timeline-spin">',
                                '<img src="' + window.CDN_URL + '/original-intention/statics/blog/img/fake-ui/head_' + generateRadomInt(5) + '.png">',
                            '</div>',
